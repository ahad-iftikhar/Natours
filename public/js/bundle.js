...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYWJkdWxhaGFkNzciLCJhIjoiY2x6Y3ZoOHZpMGJhNzJxczllaG4wazM1aiJ9.mQSBdUqVAZ_Pf4oDtQ1F6A';
...
if (mapBox) {
  var locations = JSON.parse(mapBox.dataset.locations); // Getting locations data from pug template, we have created a string of all the locations in pug template and set it into a dataset and we are accessing it here.
